...
architecture rtl of ram is
    ...
    -- Wskazanie pliku MIF zamiast inicjalizacji w kodzie
    signal ram_block : mem_type;
    attribute ram_init_file : string;
    attribute ram_init_file of ram_block : signal is "ram_init.mif";

begin
    -- Synchroniczny zapis (bez zmian)
    process(clk)
    begin
    ...
    -- Asynchroniczny odczyt (bez zmian)
